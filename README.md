A zipping library based on [yazl](https://github.com/thejoshwolfe/yazl). This library a provides better API and state management, while using the same low-level serialization logic.
